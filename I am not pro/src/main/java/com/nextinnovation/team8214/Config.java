...
public final class Config {
  ...
  public enum LiveDebugGroup {
    ...
    public static void updateGroupActive() {
      ...
      LoggedTunableNumber.setGroupActive(
              SWERVE.toString(), GLOBAL.groupActiveSupplier.getAsBoolean());
      LoggedTunableNumber.setGroupActive(
              ODOMETRY.toString(), GLOBAL.groupActiveSupplier.getAsBoolean());
      LoggedTunableNumber.setGroupActive(
              TURRET.toString(), GLOBAL.groupActiveSupplier.getAsBoolean());
    }
